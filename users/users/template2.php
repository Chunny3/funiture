                            ...
                            <form action="./doInsert.php" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 justify-content-start" role="group">
                                        <input type="checkbox" class="btn-check btn-all-lv" id="member-btncheck0"
                                            name="member-levels[]" value="all" checked>
                                        <label class="btn btn-outline-secondary rounded-pill"
                                            for="member-btncheck0">全部會員</label>
                                        <input type="checkbox" class="btn-check btn-other-lv" id="member-btncheck1"
                                            name="member-levels[]" value="">
                                        <label class="btn btn-outline-secondary rounded-pill"
                                            for="member-btncheck1">木芽會員</label>
                                        <input type="checkbox" class="btn-check btn-other-lv" id="member-btncheck2"
                                            name="member-levels[]" value="">
                                        <label class="btn btn-outline-secondary rounded-pill"
                                            for="member-btncheck2">原木會員</label>
                                        <input type="checkbox" class="btn-check btn-other-lv" id="member-btncheck3"
                                            name="member-levels[]" value="">
                                        <label class="btn btn-outline-secondary rounded-pill"
                                            for="member-btncheck3">森林會員</label>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 justify-content-start" role="group">
                                        <input type="checkbox" class="btn-check btn-all-cate" id="category-btncheck0"
                                            name="category[]" value="all" checked>
                                        <label class="btn btn-outline-primary rounded-pill"
                                            for="category-btncheck0">全部類別</label>
                                        <input type="checkbox" class="btn-check btn-other-cate" id="category-btncheck1"
                                            name="category[]" value="">
                                        <label class="btn btn-outline-primary rounded-pill"
                                            for="category-btncheck1">客廳</label>
                                        <input type="checkbox" class="btn-check btn-other-cate" id="category-btncheck2"
                                            name="category[]" value="">
                                        <label class="btn btn-outline-primary rounded-pill"
                                            for="category-btncheck2">臥室</label>
                                    </div>
                                </div>
