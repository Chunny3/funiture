            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <h1 class="h3 text-gray-800 ml-3">使用者管理系統</h1>
                        <div class="mr-3">
                            <a href="./insert.php" class="btn btn-info btn-sm">新增使用者&nbsp;&nbsp;<i
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                            <tr class="mb-1">
                                                ...
                                                <td>131415</td>
                                                <td>546456</td>
                                                <td><span class='date-status date-pending'>未生效</span></td>
                                                <td>5645123</td>
                                                <td>
                                                    ...
                                                    <a class="a-edit" href="./update.php?id="><i
                                                            class="fa-solid fa-pencil"></i></a>
                                                    <button class="btn-del" data-id=""><i
                                            ...
                                            <tr class="mb-1">
                                                ...
                                                <td>131415</td>
                                                <td>546456</td>
                                                <td><span class='date-status date-expired'>過期</span></td>
                                                <td>5645123</td>
                                                <td>
                                                    <button type="button" class="btn-view" data-toggle="modal"
                                                        data-target="#viewModal123">
                                            ...
                                            <tr class="mb-1">
                                                ...
                                                <td>131415</td>
                                                <td>546456</td>
                                                <td><span class='date-status date-active'>有效</span></td>
                                                <td>5645123</td>
                                                <td>
                                                    <button type="button" class="btn-view" data-toggle="modal"
                                                        data-target="#viewModal123">
