...
<body>
        ...
        <div class="p-5 d-flex justify-content-center align-items-center" style="height: 100vh;">
          <div class="w-100" style="max-width: 400px; margin: auto;">
            <div class="text-center">
              <h1 class="h4 text-gray-900 mb-4">建立 Oak!y 帳號</h1>
            </div>
            <form class="user" action="./doRegister.php" method="post" enctype="multipart/form-data">
              <!-- 頭像上傳 -->
              ...
              <div class="form-group mb-3">
                <input type="text" class="form-control form-control-user" name="birthday" placeholder="yyyy/mm/dd"
                  required>
              </div>
              <div class="form-group mb-3">
                <input type="text" class="form-control form-control-user" name="phone" placeholder="0912345678"
                  required>
              </div>

              <div class="form-group mb-2 d-flex">
                <input type="text" name="zipcode" id="zipcode" class="form-control form-control-user2 me-2" readonly
                  style="max-width: 80px;" placeholder="郵遞區號" value="<?= htmlspecialchars($row['zipcode'] ?? "") ?>">
                <select name="city" id="city" class="form-control form-control-user2" style="max-width:120px;">
                  <option selected disabled >請選擇縣市</option>
                </select>
                <select name="area" id="area" class="form-control"
                  style="max-width:120px; color:rgb(110,112,116); z-index: 999;">
              ...
              <!-- <input type="text" name="zipcode" id="zipcode" class="form-control" readonly placeholder="郵遞區號"
                value="<?= htmlspecialchars($row['zipcode'] ?? "") ?>">
              ...
              <select name="area" id="area" class="form-select">
                ...
                <div class="form-group mb-3">
                  <input type="text" class="form-control form-control-user" name="address" placeholder="路街巷弄,樓層號"
                    required>
                </div>
                ...
                <div class="text-center mt-2">
                  <a class="small" href="login.php" style="color: #719a8b;">已經有帳號？登入</a>
                </div>
            </form>
          </div>
        </div>
  ...
  <script>
    ...
    citySelect.addEventListener("change", () => {
      areaSelect.innerHTML = '<option value="" selected disabled>請選擇區域</option>';
