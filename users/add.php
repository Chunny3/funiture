  ...
  <div class="container mt-5">
    <div class="card shadow max-width1200 mx-auto">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold  text-white">註冊 - 加入會員</h6>
      </div>
      ...
      <div class="container mt-3 max-width800">
        ...
        <form action="./doAdd.php" method="post" enctype="multipart/form-data">
          ...
          <div class="input-group mb-2">
            ...
            <input required name="password1" type="password" class="form-control" placeholder="使用者密碼">
          </div>
          <div class="input-group mb-2">
            <span class="input-group-text">密碼</span>
            <input required name="password2" type="password" class="form-control" placeholder="再輸入一次使用者密碼">
          </div>
          <div class="input-group mb-2">
          ...
          <div class="input-group mb-2">
            ...
            <input required name="birthday" type="text" class="form-control" placeholder="yyyy/mm/dd">
          </div>
          <div class="input-group mb-2">
          ...
          <div class="input-group mb-2 align-items-center">
            <input name="myFile" type="file" class="form-control" accept="image/*">
            <!--           
          <?php if (!empty($row['img'])): ?>
            <img src="../uploads/<?= htmlspecialchars($row['img']) ?>" alt="使用者圖片" class="img-thumbnail ms-2"
              style="max-width: 100px; max-height: 100px;">
          <?php else: ?>
            <img class="rounded-circle ms-2" src="../uploads/no-image.jpg" alt="照片" style="width:40px; height:40px;">
          <?php endif; ?> -->
          </div>
          <!-- <img class="rounded-circle" src="../uploads/no-image.jpg" alt="照片" style="width:40px; height:40px;"
                        id="imgPreview"> -->
          <div class="mb-4 text-end">
            <button type="submit" class="btn btn-info">確認</button>
            <a class="btn btn-info" href="./index.php">取消</a>
          </div>
        </form>
      </div>
    </div>
