                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow max-width1200 mx-auto">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-white">編輯優惠券</h6>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input required name="code" type="text" class="form-control"
                                                value="<?= $row["code"] ?>" minlength="5" maxlength="12" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <select id="discount_type" name="discount-type" class="form-select"
                                                ...
                                                <option value="1" <?= (is_array($row) && $row["discount_type"] == 1) ? "selected" : "" ?>>現金折扣
                                                </option>
                                                <option value="2" <?= (is_array($row) && $row["discount_type"] == 2) ? "selected" : "" ?>>百分比折扣
                                                </option>
                                            </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input name="max-amount" type="number" class="form-control" min="0"
                                                placeholder="未填寫則不限數量" value="<?= $row["max_amount"] ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center mb-2 gap-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="expire-type"
                                                id="expire_fixed" value="fixed" <?= !empty($row["start_at"]) ? "checked" : "" ?>>
                                            <label class="form-check-label" for="expire_fixed">固定日期區間</label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="expire-type"
                                                id="expire_relative" value="relative" <?= $row["valid_days"] !== null ? "checked" : "" ?>>
                                            <label class="form-check-label" for="expire_relative">領取後有效天數</label>
                                        </div>
                                    </div>

                                    <!-- 固定日期區塊 -->
                                    <div id="fixed_section" class="row mb-4 d-none">
                                        <div class="col-md-6">
                                            <div class="input-group">
